...
from preprocess import Reddit12k
class InfoGraph(nn.Module):
  def __init__(self, hidden_dim=32, num_gc_layers=3, alpha=0.5, beta=1., gamma=.1):
    ...
    self.encoder = Encoder(1, hidden_dim, num_gc_layers)
...
if __name__ == '__main__':
    ...
    print('Training complete, start saving model...')
    torch.save(model.state_dict(), 'Encoder_state_dict.pkl')
    print('Model saved.')
